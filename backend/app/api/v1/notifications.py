...
from app.models.extra import Notification, GuideBlockedDate
from app.core.dependencies import get_current_user, get_current_guide, get_any_authenticated
from app.utils.notification_helpers import create_notification  # noqa: F401 — re-exported for callers
...
def clear_all(current_user: User = Depends(get_any_authenticated), db: Session = Depends(get_db)):
