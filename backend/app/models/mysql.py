...
class GuideProfile(Base):
    ...
    meet_title = Column(String(200), nullable=True)
    meet_link = Column(String(500), nullable=True)
    meet_scheduled_at = Column(DateTime, nullable=True)
    meet_status = Column(Enum(MeetStatus), default=MeetStatus.not_scheduled, nullable=False)
