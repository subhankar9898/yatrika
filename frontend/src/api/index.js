...
export const bookingsApi = {
  ...
  reschedule: (bookingId, newSlotId) => api.put(`/bookings/${bookingId}/reschedule`, { new_slot_id: newSlotId }),
...
export const adminApi = {
  ...
  scheduleGuideMeet: (guideProfileId, data) =>
    api.post(`/admin/guides/${guideProfileId}/schedule-meet`, data),
  ...
  assignGuide: (placeId, guideId) => api.post(`/admin/places/${placeId}/assign-guide?guide_id=${guideId}`),
  deletePlace: (id) => api.delete(`/admin/places/${id}`),
}
export const chatApi = {
  getHistory: (bookingId) => api.get(`/chat/${bookingId}/history`),
}
