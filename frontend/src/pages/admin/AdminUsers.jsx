...
import { FiSearch, FiPlus, FiEdit2, FiTrash2, FiX, FiCheck, FiPieChart, FiClock, FiUsers, FiCompass, FiMapPin, FiShield, FiList, FiGrid } from 'react-icons/fi'
import DashboardLayout from '../../components/layout/DashboardLayout'
import { adminApi } from '../../api/index'
import { useDebounce } from '../../hooks'
import useAuthStore from '../../store/authStore'
import toast from 'react-hot-toast'
import { Select, ROLE_OPTIONS, ROLE_FORM_OPTIONS } from '../../components/ui/Dropdown'
            ...
            >
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <Select value={form.role} onChange={(v) => setForm({ ...form, role: v })} options={ROLE_FORM_OPTIONS} />
                    </div>
        ...
        <DashboardLayout navItems={NAV} icon={<FiShield className="inline" />}>
            <div className="space-y-5">
                ...
                <div className="flex gap-3 flex-wrap">
                    ...
                    <Select className="w-36" value={roleFilter} onChange={setRoleFilter} options={ROLE_OPTIONS} />
                </div>
                                        ...
                                        >
                                            <td className="px-4 py-3">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-8 h-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold text-sm flex-shrink-0 overflow-hidden">
                                                        <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(u.full_name + u.id)}&backgroundColor=b6e3f4,c0aede,d1d4f9,ffdfbf,ffd5dc`} alt={u.full_name} className="w-full h-full object-cover" />
                                                    </div>
                                                    <div>
                                                ...
                                                {u.id === useAuthStore.getState().user?.id ? (
                                                    ...
                                                    <div className="flex items-center justify-end gap-2">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`text-xs px-3 py-1.5 rounded-lg border transition-colors ${u.is_active
