...
const SORT_OPTIONS = [
  { value: 'google_rating:desc', label: 'Highest Rated' },
  { value: 'google_rating:asc', label: 'Lowest Rated' },
  { value: 'name:asc', label: 'Name A–Z' },
  { value: 'entrance_fee_inr:asc', label: 'Fee: Low to High' },
  { value: 'entrance_fee_inr:desc', label: 'Fee: High to Low' },
  { value: 'time_needed_hrs:asc', label: 'Shortest Visit' },
]
...
export default function PlacesPage() {
 ...
 {/* Header banner */}
 <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white py-6 sm:py-10 px-4">
 ...
 Filters
 {activeFilterCount > 0 && (
 <span className="badge bg-emerald-500 text-white text-xs">{activeFilterCount}</span>
 )}
 </button>
 ...
 "{search}"
 <button onClick={() => setSearch('')} className="ml-1 hover:text-emerald-900">×</button>
 </span>
 )}
 {filters.state && (
