...
export default function RegisterGuidePage() {
 ...
 setShowOTP(false)
 toast.success('Email verified! Admin will review your guide application.')
 navigate('/login')
 }
 ...
 <strong>Note:</strong> Verify your email with OTP first. After that, admin will review your guide application.
 </div>
 ...
 placeholder="Create a strong password" required value={form.password}
 ...
 <p className="text-xs text-gray-400">OTP verification is required before admin review.</p>
 <button type="submit" disabled={loading || !isPasswordValid(form.password)} className="w-full btn-primary py-3 text-base disabled:opacity-50">
